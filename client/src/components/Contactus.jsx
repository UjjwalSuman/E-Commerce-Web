...
export const Contactus = () => {
  ...
  return (
    <div>
        <section class="flex flex-col py-10 px-2 max-w-6xl mt-4 mb-4 rounded-lg mx-auto gap-2 bg-white ">
            <div class="container px-6 py-2 mx-auto">
                <div class="text-center ">
                    <p class="font-bold text-2xl text-blue-500 dark:text-blue-400">Contact us</p>

                    <h1 class="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-black">We’d love to hear from you</h1>

                    <p class="mt-3 text-gray-600 dark:text-gray-600">Chat to our friendly team.</p>
                </div>
                ...
                <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3 sm:grid-cols-2 ">
                    <div class="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                        ...
                        <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">ujjwalsuman30@gmail.com</p>
                    </div>
                    ...
                    <div class="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                        ...
                        <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">
                            123, Navrangpura Railway Crossing,
                            Ahmedabad, India
                        </p>
                    </div>
                    ...
                    <div class="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                        ...
                        <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">+91 1234 567 890</p>
                    </div>
                </div>
            </div>
        </section> 
